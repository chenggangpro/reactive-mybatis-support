                ...
                if ("package".equals(child.getName())) {
                    ...
                    if (resource != null && url == null && mapperClass == null) {
                        ...
                        try (InputStream inputStream = Resources.getResourceAsStream(resource)) {
                            R2dbcXMLMapperBuilder mapperParser = new R2dbcXMLMapperBuilder(inputStream, configuration, resource, configuration.getSqlFragments());
                            mapperParser.parse();
                        }
                    } else if (resource == null && url != null && mapperClass == null) {
                        ErrorContext.instance().resource(url);
                        try (InputStream inputStream = Resources.getUrlAsStream(url)) {
                            R2dbcXMLMapperBuilder mapperParser = new R2dbcXMLMapperBuilder(inputStream, configuration, url, configuration.getSqlFragments());
                            mapperParser.parse();
                        }
                    } else if (resource == null && url == null && mapperClass != null) {
