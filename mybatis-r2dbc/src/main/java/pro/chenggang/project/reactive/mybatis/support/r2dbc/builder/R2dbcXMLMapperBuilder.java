 ...
 */
public class R2dbcXMLMapperBuilder extends XMLMapperBuilder {
  ...
  public R2dbcXMLMapperBuilder(InputStream inputStream,
  ...
  private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) {
    for (XNode context : list) {
      final R2dbcXMLStatementBuilder statementParser = new R2dbcXMLStatementBuilder(configuration, builderAssistant, context,
          requiredDatabaseId);
      try {
