 ...
 */
public class R2dbcXMLStatementBuilder extends XMLStatementBuilder {

  private final MapperBuilderAssistant builderAssistant;
  private final XNode context;
  private final String requiredDatabaseId;

  public R2dbcXMLStatementBuilder(Configuration configuration, MapperBuilderAssistant builderAssistant, XNode context) {
  ...
  public void parseStatementNode() {
    ...
    if (resultTypeClass == null && resultMap == null) {
      resultTypeClass = R2dbcMapperAnnotationBuilder.getMethodReturnType(builderAssistant.getCurrentNamespace(), id);
    }
