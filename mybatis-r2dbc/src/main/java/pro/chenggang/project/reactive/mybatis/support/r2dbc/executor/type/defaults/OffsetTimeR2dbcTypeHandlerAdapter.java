...
public class OffsetTimeR2dbcTypeHandlerAdapter implements R2dbcTypeHandlerAdapter<OffsetTime> {
    ...
    @Override
    public OffsetTime getResult(Readable readable, ReadableMetadata readableMetadata, String columnName) {
    ...
    @Override
    public OffsetTime getResult(Readable readable, ReadableMetadata readableMetadata, int columnIndex) {
