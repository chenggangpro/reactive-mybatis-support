...
public class TimestampR2dbcTypeHandlerAdapter implements R2dbcTypeHandlerAdapter<Timestamp> {
    ...
    @Override
    public Timestamp getResult(Readable readable, ReadableMetadata readableMetadata, String columnName) {
    ...
    @Override
    public Timestamp getResult(Readable readable, ReadableMetadata readableMetadata, int columnIndex) {
