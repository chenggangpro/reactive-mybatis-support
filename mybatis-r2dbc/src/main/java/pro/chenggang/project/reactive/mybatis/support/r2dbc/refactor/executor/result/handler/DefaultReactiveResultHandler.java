...
public class DefaultReactiveResultHandler implements ReactiveResultHandler {
    ...
    public DefaultReactiveResultHandler(R2dbcConfiguration r2dbcConfiguration, MappedStatement mappedStatement) {
        this.mappedStatement = mappedStatement;
        this.r2dbcConfiguration = r2dbcConfiguration;
        this.objectFactory = r2dbcConfiguration.getObjectFactory();
        this.reflectorFactory = r2dbcConfiguration.getReflectorFactory();
    ...
    private Object getRowValueForSimpleResultMap(RowResultWrapper rowResultWrapper, ResultMap resultMap, String columnPrefix) throws SQLException {
        ...
        if (rowValue != null && !hasTypeHandlerForResultObject(resultMap.getType())) {
            final MetaObject metaObject = r2dbcConfiguration.newMetaObject(rowValue);
            ...
            rowValue = foundValues || r2dbcConfiguration.isReturnInstanceForEmptyRow() ? rowValue : null;
        }
        return rowValue;
    }
    ...
    private boolean applyPropertyMappings(RowResultWrapper rowResultWrapper, ResultMap resultMap, MetaObject metaObject, String columnPrefix)
        ...
        for (ResultMapping propertyMapping : propertyMappings) {
            ...
            if (propertyMapping.isCompositeResult()
                ...
                if (value != null || (r2dbcConfiguration.isCallSettersOnNulls() && !metaObject.getSetterType(property).isPrimitive())) {
    ...
    private List<DefaultReactiveResultHandler.UnMappedColumnAutoMapping> createAutomaticMappings(RowResultWrapper rowResultWrapper, ResultMap resultMap, MetaObject metaObject, String columnPrefix) throws SQLException {
        ...
        if (autoMapping == null) {
            ...
            for (String columnName : unmappedColumnNames) {
                ...
                final String property = metaObject.findProperty(propertyName, r2dbcConfiguration.isMapUnderscoreToCamelCase());
                if (property != null && metaObject.hasSetter(property)) {
                    ...
                    if (typeHandlerRegistry.hasTypeHandler(propertyType)) {
                        ...
                        r2dbcConfiguration.getAutoMappingUnknownColumnBehavior()
    ...
    private boolean applyAutomaticMappings(RowResultWrapper rowResultWrapper, ResultMap resultMap, MetaObject metaObject, String columnPrefix) throws SQLException {
        ...
        if (!autoMapping.isEmpty()) {
            for (DefaultReactiveResultHandler.UnMappedColumnAutoMapping mapping : autoMapping) {
                ...
                if (value != null || (r2dbcConfiguration.isCallSettersOnNulls() && !mapping.primitive)) {
                    // gcode issue #377, call setter on nulls (value is not 'found')
        ...
        for (ResultMapping constructorMapping : constructorMappings) {
            ...
            try {
                if (constructorMapping.getNestedQueryId() != null) {
                    ...
                    final ResultMap resultMap = r2dbcConfiguration.getResultMap(constructorMapping.getNestedResultMapId());
    ...
    public ResultMap resolveDiscriminatedResultMap(RowResultWrapper rowResultWrapper, ResultMap resultMap, String columnPrefix) throws SQLException {
        ...
        while (discriminator != null) {
            ...
            if (r2dbcConfiguration.hasResultMap(discriminatedMapId)) {
                resultMap = r2dbcConfiguration.getResultMap(discriminatedMapId);
    ...
    private boolean shouldApplyAutomaticMappings(ResultMap resultMap, boolean isNested) {
        if (resultMap.getAutoMapping() != null) {
            ...
            if (isNested) {
                return AutoMappingBehavior.FULL == r2dbcConfiguration.getAutoMappingBehavior();
            } else {
                return AutoMappingBehavior.NONE != r2dbcConfiguration.getAutoMappingBehavior();
            }
        }
    }
    ...
    private ResultMap getNestedResultMap(RowResultWrapper rowResultWrapper, String nestedResultMapId, String columnPrefix) throws SQLException {
        ResultMap nestedResultMap = r2dbcConfiguration.getResultMap(nestedResultMapId);
        ...
        for (ResultMapping resultMapping : resultMappings) {
            if (resultMapping.isSimple()) {
                ...
                if (column != null && mappedColumnNames.contains(column.toUpperCase(Locale.ENGLISH))) {
                    ...
                    if (value != null || r2dbcConfiguration.isReturnInstanceForEmptyRow()) {
    ...
    private void createRowKeyForUnmappedProperties(ResultMap resultMap, RowResultWrapper rowResultWrapper, CacheKey cacheKey, String columnPrefix) throws SQLException {
        ...
        for (String column : unmappedColumnNames) {
            ...
            if (metaType.findProperty(property, r2dbcConfiguration.isMapUnderscoreToCamelCase()) != null) {
    ...
    private void linkObjects(MetaObject metaObject, ResultMapping resultMapping, Object rowValue) {
        ...
        if (collectionProperty != null) {
            final MetaObject targetMetaObject = r2dbcConfiguration.newMetaObject(collectionProperty);
