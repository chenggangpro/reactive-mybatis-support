package pro.chenggang.project.reactive.mybatis.support.r2dbc.type;
 ...
 * @author linux_china
 */
public class R2dbcEnumOrdinalTypeHandler<E extends Enum<E>> extends EnumOrdinalTypeHandler<E> implements R2DBCTypeHandler<E> {

    private Class<E> type;
    private E[] enums;

    public R2dbcEnumOrdinalTypeHandler(Class<E> type) {
        super(type);
        this.type = type;
