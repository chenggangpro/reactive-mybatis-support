...
public interface ProcedureMapper {
    ...
    Mono<Void> callInoutProcedureUsingUpdate(SimpleRowProcedureData simpleRowProcedureData);

    Mono<Void> callInoutProcedureUsingSelect(SimpleRowProcedureData simpleRowProcedureData);

    Mono<Void> callOutputProcedureUsingUpdate(SimpleRowProcedureData simpleRowProcedureData);
