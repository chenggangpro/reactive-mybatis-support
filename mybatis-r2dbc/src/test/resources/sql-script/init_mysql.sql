...
INSERT INTO `subject`
VALUES (1, 'a', 10, 100, 45, 1, CURRENT_TIMESTAMP, 222222222),
       (2, 'b', 10, NULL, 45, 1, CURRENT_TIMESTAMP, 222222222),
       (2, 'c', 10, NULL, NULL, 0, CURRENT_TIMESTAMP, 222222222);

INSERT INTO `subject_data`
VALUES (1, 1, 'a', 1, 1, 1, 1.0, 1, 'a', 'A', 10.23, CURRENT_TIMESTAMP, DATE(NOW()), NOW()),
       (2, 2, 'b', 2, 2, 2, 2.0, 0, 'b', 'B', 10.23, CURRENT_TIMESTAMP, DATE(NOW()), NOW()),
       (3, 3, 'c', 3, 3, 3, 3.0, 1, 'c', 'C', 10.23, CURRENT_TIMESTAMP, DATE(NOW()), NOW());